          ...
          <ul id="menu-list" class="hidden">
            <li>
              ...
              <ul class="dropdown-menu">
                <li><a href="./HTML/kindergarten/kidergarten.html">Kindergarten and Pre-K</a></li>
                <li><a href="./HTML/Grade 1/Grade1/grade1.html">Grade 1</a></li>
                <li><a href="GRADE 2/HTML/Grade2.html">Grade 2</a></li>
            ...
            <li>
              ...
              <li>
                ...
                <ul class="dropdown-menu">
                  <li><a href="./index.php">Lgin with admin</a></li>
          ...
          <div class="project-container">
            <article class="article-wrapper">
              <div class="rounded-lg container-project">
                <a href="./HTML/kindergarten/kidergarten.html"><img class="rounded-lg container-project" src="image/kindergarten.jpg" alt=""></a>
                </div>
                <div class="project-info">
                  <div class="flex-pr">
                    <div class="project-title text-nowrap">Kindergarten</div>
                      <div class="project-hover">
                        <a href="kidergarten.html">
